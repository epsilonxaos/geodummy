			...
			<aside className={`${!active ? "w-[50px]" : "w-[200px]"} group  ${active && ("sidebar-is-active")} bg-white dark:bg-gray-800 transition-all h-full fixed top-0 left-0 z-10 border-r dark:border-r-slate-800`} aria-label="Sidebar" style={{boxShadow: "0 2px 2px 0 rgb(0, 0, 0, 0.2)"}} ref={ref}>
				<div className="dark:bg-gray-800">
					<div className="bg-[#254088] dark:bg-black px-4 py-3.5">
						<div className="flex items-center justify-center group-[.sidebar-is-active]:justify-start text-white">
							<FiMenu size={"24px"} className="cursor-pointer" onClick={() => handlerToggleActive()} />
							<p className="font-semibold hidden group-[.sidebar-is-active]:block text-lg pl-5">GEOPORTAL</p>
						</div>

						<div className="hidden group-[.sidebar-is-active]:flex items-center justify-between pt-6 text-white">
							<p>Anónimo</p>
							<RxCaretDown />
						</div>
					</div>
					<ul className="text-[#6e7a81] dark:text-gray-200">
						<li className="py-3.5 flex justify-center items-center cursor-pointer group-[.sidebar-is-active]:justify-start px-4 bg-sky-100 dark:bg-gray-700">
