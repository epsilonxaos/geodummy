...
const TrList = ({addMarker, id, estado, tipo, referencia, etapa, location, active}) => {
	return(
		<tr className={` border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 ${id == active ? 'bg-gray-100 dark:bg-gray-600' : 'bg-white'}`}>
			<th scope="row" className="cursor-pointer px-6 py-1 font-medium text-gray-900 whitespace-nowrap dark:text-white" onClick={() => addMarker(location, id)}>
				{id}
			</th>
			<td className="cursor-pointer px-6 py-1" onClick={() => addMarker(location, id)}>
			...
			<td className="px-6 py-1 dark:text-gray-800">
