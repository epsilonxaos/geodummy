		...
		<GtModal isOpen={isOpen} toggle={toggle} classContent="rounded-none">
			<div className="w-80">
				...
				<GtModal.Footer className="justify-end border-none pb-2 px-4">
					<button type="button" className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 font-medium text-sm px-5 py-2 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600" onClick={() => toggle()}>Cancelar</button>
					<button type="button" className="focus:outline-none text-white bg-green-700 hover:bg-green-800 font-medium text-sm px-5 py-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700">Aplicar</button>
				</GtModal.Footer>
			</div>
		</GtModal>
	)
