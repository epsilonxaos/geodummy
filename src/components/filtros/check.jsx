const GtCheck = ({id, value, label, nivel, handlerClick, checkchilds}) => {
	return(
		<div className="flex items-center mb-3">
			<input id={id} type="checkbox" value={value} data-nivel={nivel} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:shadow-none focus:ring-transparent rounded"
